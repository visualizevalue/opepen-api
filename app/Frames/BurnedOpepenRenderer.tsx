...
export default class BurnedOpepenRenderer extends Renderer {
  ...
  public static async render (opepen: BurnedOpepen, force: boolean = false) {
    ...
    const png = await this.png(await this.svg(
      ...
      >
        <img src={ `https://ipfs.vv.xyz/ipfs/${url.replace('ipfs://', '')}` } alt="Burned Opepen Image" width="1000" height="1000" />
        <div
          style={{
            display: 'flex',
        ...
        >
            ...
            >
            <img src={`${Env.get('APP_URL')}/${opepen.opepen.tokenId}/render`} alt="Opepen Image" width="400" height="400" />
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'flex-start',
