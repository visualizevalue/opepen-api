  ...
  public static async render(opepen: Opepen, force: boolean = false) {
    ...
    const png = await this.png(
      await this.svg(
        ...
        >
          <img
            src={`${Env.get('APP_URL')}/${opepen.tokenId}/render`}
            alt="Opepen Image"
            width="1000"
            height="1000"
          />
          ...
          >
            ...
            <img
              ...
              src="https://opepen.nyc3.cdn.digitaloceanspaces.com/check-white.png"
              width="24"
              height="24"
            />
            <p style={{ margin: '26px 0 0', lineHeight: '1' }}>1 of {opepen.data.edition}</p>
            <p style={{ opacity: '0.5', margin: '20px 0', lineHeight: '1' }}>
              Opepen {opepen.tokenId.toString()}
            </p>
            ...
            >
              {opepen.setId ? submission[`edition_${opepen.data.edition}Name`] : `Unrevealed`}
            </h1>
            ...
            {opepen.setId && (
              <div style={{ display: 'flex', flexDirection: 'column', margin: '0' }}>
                ...
                <p style={{ margin: '12px 0' }}>By {await submission.artist}</p>
                <p style={{ margin: '12px 0' }}>{submission.editionType} Editions</p>
                <p style={{ margin: '12px 0 0' }}>
                  Consensus on {submission.revealsAt && formatDate(submission.revealsAt)}
                </p>
              </div>
            )}
