...
const DEFAULT_PFP: string =
  'https://opepenai.nyc3.digitaloceanspaces.com/images/764c9320-05a9-4329-87a5-117277d21df9@sm.png'
...
export default class AccountRenderer extends Renderer {
  ...
  public static async renderWithOwnedOpepen(account: Account) {
    ...
    const opepenOnDisplay = opepen
      ...
      .sort((a, b) =>
        a.setId === null ? 1 : b.setId === null ? -1 : a.setId > b.setId ? 1 : -1,
      )
      .slice(0, perSide ** 2)
